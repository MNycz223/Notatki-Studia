...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[fill=gray]
            ...
            \fill (0.5,0) circle (1);
            % outline
            \draw (-0.5,0) circle (1) (-1,0)  node [text=white,above] {$A$}
                (0.5,0) circle (1) (1,0)  node [text=white,above] {$B$}
